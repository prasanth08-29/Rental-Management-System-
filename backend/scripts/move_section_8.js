...
const updateTemplate = async () => {
    try {
        ...
        if (template) {
            // Changes:
            // 1. Moved Section 8 (Indemnity & Legal) to the Right Column, under Section 7.
            // 2. Kept the compact layout changes from previous steps.
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.3; padding: 10px 20px; max-width: 800px; margin: auto; border: 1px solid #eee; background: #fff;">
    ...
    <div style="display: flex; gap: 20px; margin-top: 15px; border-top: 1px solid #eee; padding-top: 10px;">
        ...
        <!-- Right Column (Now includes Section 8) -->
        <div style="flex: 1; padding-left: 0;">
            ...
            <h3 style="border-bottom: 1px solid #ccc; margin-top: 15px; margin-bottom: 5px; font-size: 15px;">8. Indemnity & Legal</h3>
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
    ...
    <p style="font-size: 10px; font-style: italic; margin-top: 15px; margin-bottom: 5px;">Note: Renter should produce a copy of ID and address proof during the time of the agreement signing.</p>
...
`;
            ...
            await template.save();
            console.log('Template section 8 moved!');
        } else {
