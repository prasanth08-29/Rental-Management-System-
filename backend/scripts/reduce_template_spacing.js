...
const updateSpacing = async () => {
    try {
        ...
        if (template) {
            ...
            // Reduced header margin-bottom from 15px to 5px
            // Reduced H2 margin-bottom from 15px to 10px
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.3; padding: 10px 20px; max-width: 800px; margin: auto; border: 1px solid #eee; background: #fff;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #800000; padding-bottom: 5px; margin-bottom: 5px;">
    ...
    <h2 style="text-align: center; text-decoration: underline; margin-bottom: 10px; margin-top: 0;">Homecare Equipment Rental Agreement</h2>
    
    <p style="margin-bottom: 5px;">This agreement is made on <strong>{{AGREEMENT_DATE}}</strong>, between:</p>
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 10px; margin-bottom: 5px; font-size: 16px;">1. Equipment Details</h3>
    <ul style="margin-top: 5px; margin-bottom: 10px;">
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 10px; margin-bottom: 5px; font-size: 16px;">8. Indemnity & Legal</h3>
    <ul style="margin-top: 5px; margin-bottom: 10px;">
...
`;
            ...
            await template.save();
            console.log('Template spacing updated!');
        } else {
