...
const updateWithSeparator = async () => {
    try {
        ...
        if (template) {
            // We will restructure the layout for sections 4-7 to have a vertical line
            // We keep Sections 1-3 and 8 as is (from the previous verified state)

            const newContent = `
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.3; padding: 20px; max-width: 800px; margin: auto; border: 1px solid #eee; background: #fff;">
    ...
    <h2 style="text-align: center; text-decoration: underline; margin-bottom: 15px; margin-top: 0;">Homecare Equipment Rental Agreement</h2>
    
    <p style="margin-bottom: 10px;">This agreement is made on <strong>{{AGREEMENT_DATE}}</strong>, between:</p>
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 15px; margin-bottom: 5px; font-size: 16px;">1. Equipment Details</h3>
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 10px; margin-bottom: 5px; font-size: 16px;">2. Rental Period</h3>
    <ul style="margin-top: 5px; margin-bottom: 10px;">
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 10px; margin-bottom: 5px; font-size: 16px;">3. Rental Charges</h3>
    ...
    <div style="display: flex; gap: 20px; margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px;">
        
        <!-- Left Column -->
        <div style="flex: 1; border-right: 1px solid #ccc; padding-right: 20px;">
            <h3 style="border-bottom: 1px solid #ccc; margin-top: 0; margin-bottom: 5px; font-size: 16px;">4. Responsibility of the Renter</h3>
            ...
            <h3 style="border-bottom: 1px solid #ccc; margin-top: 15px; margin-bottom: 5px; font-size: 16px;">6. Maintenance & Support</h3>
        ...
        <div style="flex: 1; padding-left: 0;">
            <h3 style="border-bottom: 1px solid #ccc; margin-top: 0; margin-bottom: 5px; font-size: 16px;">5. Liability for Damage or Loss</h3>
            <ul style="margin-top: 5px; margin-bottom: 15px; padding-left: 20px;">
            ...
            <h3 style="border-bottom: 1px solid #ccc; margin-top: 15px; margin-bottom: 5px; font-size: 16px;">7. Termination & Return</h3>
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
    ...
    <h3 style="border-bottom: 1px solid #ccc; margin-top: 15px; margin-bottom: 5px; font-size: 16px;">8. Indemnity & Legal</h3>
    <ul style="margin-top: 5px; margin-bottom: 10px;">
    ...
    <div style="margin-top: 5px; display: flex; justify-content: space-between; font-size: 12px; margin-bottom: 20px;">
        <div>Date: ___________</div>
        <div>Date: ___________</div>
    </div>

    <p style="font-size: 10px; font-style: italic; margin-top: 10px; margin-bottom: 10px;">Note: Renter should produce a copy of ID and address proof during the time of the agreement signing.</p>

    <div style="border-top: 2px solid #800000; padding-top: 10px; text-align: center; font-size: 11px;">
...
`;
            ...
            await template.save();
            console.log('Template updated with separator line!');
        } else {
